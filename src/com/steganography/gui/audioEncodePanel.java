...
public class audioEncodePanel extends JFrame {
    private JTextField messageField;
    private JLabel imageLabel;
    private File selectedFile;

    public audioEncodePanel() {
        ...
        encodeButton.addActionListener((ActionEvent e) -> {
            if (selectedFile != null && !messageField.getText().isEmpty()) {
                boolean success = AudioSteganographyUtil.encodeMessage(selectedFile, messageField.getText());
